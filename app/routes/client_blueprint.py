...
from app.controllers.client_controllers import create, get_client, get_all,update,delete,schedule_appointment,get_by_email
...
bp_clients.get('/user')(jwt_required()(get_client))
